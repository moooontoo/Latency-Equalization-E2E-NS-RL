...
class Net(nn.Module):
    def __init__(self):
        ...
        self.fc41 = nn.Linear(num, 60)
        self.fc41_p = nn.Linear(60, num)
        self.fc41_c = nn.Linear(60, num)
        self.fc42_p = nn.Linear(60, num)
        self.fc42_c = nn.Linear(60, num)
        self.fc43_p = nn.Linear(60, num)
        self.fc43_c = nn.Linear(60, num)
        self.fc44_p = nn.Linear(60, num)
        self.fc44_c = nn.Linear(60, num)
        self.fc45_p = nn.Linear(60, num)
        self.fc45_c = nn.Linear(60, num)
        self.fc46_p = nn.Linear(60, num)
        self.fc46_c = nn.Linear(60, num)
        self.fc47_p = nn.Linear(60, num)
        self.fc47_c = nn.Linear(60, num)
        self.fc48_p = nn.Linear(60, num)
        self.fc48_c = nn.Linear(60, num)
        self.fc49_p = nn.Linear(60, num)
        self.fc49_c = nn.Linear(60, num)
        self.fc50_p = nn.Linear(60, num)
        self.fc50_c = nn.Linear(60, num)
    ...
    def forward(self, x):
        ...
        x41_p = self.dropout(F.relu(self.fc41_p(x))).view(-1, 1, num)  # 20
        x41_c = self.dropout(F.relu(self.fc41_c(x))).view(-1, 1, num)  # 6
        x42_p = self.dropout(F.relu(self.fc42_p(x))).view(-1, 1, num)  # 20
        x42_c = self.dropout(F.relu(self.fc42_c(x))).view(-1, 1, num)  # 6
        x43_p = self.dropout(F.relu(self.fc43_p(x))).view(-1, 1, num)  # 20
        x43_c = self.dropout(F.relu(self.fc43_c(x))).view(-1, 1, num)  # 6
        x44_p = self.dropout(F.relu(self.fc44_p(x))).view(-1, 1, num)  # 20
        x44_c = self.dropout(F.relu(self.fc44_c(x))).view(-1, 1, num)  # 6
        x45_p = self.dropout(F.relu(self.fc45_p(x))).view(-1, 1, num)  # 20
        x45_c = self.dropout(F.relu(self.fc45_c(x))).view(-1, 1, num)  # 6
        x46_p = self.dropout(F.relu(self.fc46_p(x))).view(-1, 1, num)  # 20
        x46_c = self.dropout(F.relu(self.fc46_c(x))).view(-1, 1, num)  # 6
        x47_p = self.dropout(F.relu(self.fc47_p(x))).view(-1, 1, num)  # 20
        x47_c = self.dropout(F.relu(self.fc47_c(x))).view(-1, 1, num)  # 6
        x48_p = self.dropout(F.relu(self.fc48_p(x))).view(-1, 1, num)  # 20
        x48_c = self.dropout(F.relu(self.fc48_c(x))).view(-1, 1, num)  # 6
        x49_p = self.dropout(F.relu(self.fc49_p(x))).view(-1, 1, num)  # 20
        x49_c = self.dropout(F.relu(self.fc49_c(x))).view(-1, 1, num)  # 6
        x50_p = self.dropout(F.relu(self.fc50_p(x))).view(-1, 1, num)  # 20
        x50_c = self.dropout(F.relu(self.fc50_c(x))).view(-1, 1, num)  # 6
    ...
    x30_p, x30_c,x31_p,x31_c,x32_p,x32_c,x33_p,x33_c,x34_p,x34_c,x35_p,x35_c,x36_p,x36_c,x37_p,x37_c,x38_p,x38_c,x39_p,x39_c,x40_p,x40_c,x41_p, x41_c, x42_p, x42_c, x43_p, x43_c, x44_p, x44_c, x45_p, x45_c, x46_p, x46_c, x47_p, x47_c, x48_p, x48_c, x49_p, x49_c, x50_p, x50_c
        # x_c:su_c 次用户信道分配
        # x_p:su_p 次用户功率分配
