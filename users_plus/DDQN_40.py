...
from users_plus.network_40 import Network
from users_plus.DeepQNetwork_40 import *
from users_plus.config_40 import *
...
def select_action(state,act_net):
    ...
    x30_p, x30_c,x31_p,x31_c,x32_p,x32_c,x33_p,x33_c,x34_p,x34_c,x35_p,x35_c,x36_p,x36_c,x37_p,x37_c,x38_p,x38_c,x39_p,x39_c,x40_p,x40_c = act_net(state)
    # 功率选择为20个功率等级
    ...
    x_p = np.array(
        [x1_p, x2_p, x3_p, x4_p, x5_p, x6_p, x7_p, x8_p, x9_p, x10_p, x11_p, x12_p, x13_p, x14_p, x15_p, x16_p, x17_p,
         ...
         x31_p, x32_p, x33_p, x34_p, x35_p, x36_p, x37_p, x38_p, x39_p, x40_p])
    # 信道选择为6个可选信道
    ...
    x_c = np.array(
        [x1_c, x2_c, x3_c, x4_c, x5_c, x6_c, x7_c, x8_c, x9_c, x10_c, x11_c, x12_c, x13_c, x14_c, x15_c, x16_c, x17_c,
         ...
         x31_c, x32_c, x33_c, x34_c, x35_c, x36_c, x37_c, x38_c, x39_c, x40_c])
...
def rlRan(sla,target_net,act_net,max_episodes = 5000):
    ...
    learning_rate = 0.005  # 经过实验发现learning_rate取0.001收敛速度很快，0.01很慢，0.005也还可以
    gamma = 0.995
    #episodes = 1000
    wave = []
    ...
    x30_p, x30_c ,x31_p,x31_c,x32_p,x32_c,x33_p,x33_c,x34_p,x34_c,x35_p,x35_c,x36_p,x36_c,x37_p,x37_c,x38_p,x38_c,x39_p,x39_c,x40_p,x40_c= act_net( bn_s )
            ...
            x31_p_t, x31_c_t, x32_p_t, x32_c_t, x33_p_t, x33_c_t, x34_p_t, x34_c_t, x35_p_t, x35_c_t, x36_p_t, x36_c_t, x37_p_t, x37_c_t, x38_p_t, x38_c_t, x39_p_t, x39_c_t, x40_p_t, x40_c_t = target_net( bn_s_ )
    ...
    wave = np.array(wave)
    np.savetxt('40_DDQN.csv', wave, fmt="%.6f", delimiter=',')
    torch.save(act_net.state_dict(), '../models/act_ddqn_40')
    torch.save(target_net.state_dict(), '../models/target_ddqn_40')
